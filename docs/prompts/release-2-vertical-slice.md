...
- Historias / US de Release 2 referenciadas en backlog o `PRD Floit.md`.
...
- Estado del repo: `@docs/sprints.md`.
...
> Sin ampliar scope a partner/admin: pulir SEO, errores de validación en formularios, scripts `docker:up` + `dev:services`, smoke local, consentimiento explícito en leads y página `/privacidad` borrador; documentar en `docs/sprints.md`.
