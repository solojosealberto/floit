...
| `/admin/taxonomias` | `app/admin/taxonomias/page.tsx` + `taxonomias-client.tsx` — CRUD modalidades/amenidades (`GET/POST/PATCH/DELETE` + `POST …/sync-from-venues` vía `api/admin/taxonomy-attributes*` → catalog). |
