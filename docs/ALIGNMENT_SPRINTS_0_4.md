...
- `Backlog Floit.md`
- `PRD Floit.md`
- `Plan maestro desarrollo Floit.md`
- `Plan prompt engineering Floit.md`
...
1. **OIDC-only en entorno real**
   ...
   - Ejecutar runbook `docs/oidc-rollout-sprint4.md` y documentar evidencia de flujos admin/partner.
