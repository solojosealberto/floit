  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-start justify-center overflow-y-auto bg-black/45 p-3 md:p-6">
      ...
      <div
        ...
        className="relative z-[101] my-4 w-full max-w-5xl rounded-2xl border border-neutral-200 bg-[#f7f9fc] shadow-2xl"
      >
            ...
            <div className="grid gap-4 lg:grid-cols-[1fr_320px] lg:items-start">
              <div className="space-y-4">
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        <div className="flex flex-wrap items-center gap-2">
                          <h2 id="lead-detail-title" className="text-xl font-semibold text-neutral-900">
                            {lead.name}
                          </h2>
                ...
                <section className="rounded-2xl border border-neutral-200 bg-white p-4 md:p-5">
                  ...
                  <blockquote className="mt-3 rounded-xl border border-neutral-200 bg-neutral-50 px-4 py-3 text-sm text-neutral-800">
                    {lead.message?.trim() ? (
                      <>“{lead.message.trim()}”</>
                    ) : (
                      <span className="text-neutral-500">Sin mensaje adicional.</span>
                    )}
                  </blockquote>
                </section>
                ...
                <section className="rounded-2xl border border-neutral-200 bg-white p-4 md:p-5">
                  ...
                  <ul className="mt-3 space-y-2 text-sm">
                    <li className="flex justify-between gap-4 border-b border-neutral-100 py-2">
                      <span className="text-neutral-600">Leads desde esta IP (hoy)</span>
                    ...
                    <li className="flex justify-between gap-4 border-b border-neutral-100 py-2">
                      ...
                      <span className="font-medium text-neutral-500">No disponible</span>
                    </li>
                    <li className="flex justify-between gap-4 py-2">
                      <span className="text-neutral-600">Campos completados</span>
              ...
              <div className="space-y-4">
                <section className="rounded-2xl border border-neutral-200 bg-white p-4 md:p-5">
                  <h3 className="text-sm font-semibold text-neutral-900">Estado del lead</h3>
                ...
                <section className="rounded-2xl border border-neutral-200 bg-white p-4 md:p-5">
                  <h3 className="text-sm font-semibold text-neutral-900">Historial de estado</h3>
                  <ul className="mt-4 space-y-4 border-l-2 border-neutral-200 pl-4">
                    <li className="relative">
                      ...
                      <p className="text-sm font-medium text-neutral-900">Lead recibido</p>
                    ...
                    <li className="relative">
                      <span
                        className={`absolute -left-[21px] top-1.5 h-2.5 w-2.5 rounded-full ring-4 ring-white ${
                          data.notificationEnqueuedAt ? "bg-neutral-400" : "bg-amber-400"
                        }`}
                      />
                    ...
                    {lead.firstContactedAt ? (
                      <li className="relative">
                        ...
                        <p className="text-sm font-medium text-neutral-900">Atención registrada</p>
                        <p className="text-xs text-neutral-500">
                ...
                <section className="rounded-2xl border border-neutral-200 bg-white p-4 md:p-5">
                  <h3 className="text-sm font-semibold text-neutral-900">Nota interna (admin)</h3>
                  <textarea
                    value={noteDraft}
                    onChange={(e) => setNoteDraft(e.target.value)}
                    placeholder="Agregar nota sobre este lead…"
                    rows={4}
                    className="mt-3 w-full rounded-xl border border-neutral-200 bg-white px-3 py-2.5 text-sm text-neutral-900 outline-none ring-neutral-900/10 placeholder:text-neutral-400 focus:ring-2"
                  />
                  <UIButton
                    type="button"
                    variant="secondary"
...
function DetailItem(props: { label: string; value: string }) {
  return (
    <div>
      <dt className="text-xs font-medium text-neutral-500">{props.label}</dt>
      <dd className="mt-1 text-sm font-medium text-neutral-900">{props.value}</dd>
    </div>
  );
}
