...
export default async function PartnerFotosPage(props: {
  ...
  if (preferred) {
    redirect(
      `/partner/panel?venueSlug=${encodeURIComponent(preferred)}&section=fotos`,
    );
  }
  ...
  redirect(`/partner/panel?venueSlug=${encodeURIComponent(slug)}&section=fotos`);
}
